...
source: github-auto
summary: >-
  Explore Jupyter notebooks analyzing the cost and feasibility of shipping carbon dioxide from
  Europe to US ports using Monte Carlo simulations.
tags:
  - jupyter
  - python
  - carbon-storage
...
3. Install required Python packages (assumed requirements):
...
- `carbon-storage-projects.ipynb` — Additional carbon storage related projects
